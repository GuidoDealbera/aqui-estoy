...
const AssignShifts = () => {
  ...
  const assignAccompanist = () => {
    if (selectedSupervisor && selectedAccompanist) {
      dispatch(postSupervisorCharge(selectedSupervisor, [selectedAccompanist]));      
      console.log(`Acompañante ${selectedAccompanist} asignado al supervisor ${selectedSupervisor}`);
    } else {
