        ...
        <Container sx={styles.container}>
            ...
            >
                {(props) => {
                    return (<>
                        <StyledPaper>
                            <Typography variant="h5" sx={{ display: "flex", alignItems: "center", justifyContent: "center", paddingTop: "20px" }}>Editar Perfil</Typography>
                                            ...
                                            {({ field, form }) => (
                                                <Box sx={{ width: "300px", marginBottom: "20px", display: "flex", flexDirection: "column" }}>
                                                    <Button variant="contained" component="label">
                                                        {" "}
                                                        <UploadIcon sx={{ marginRight: "10px" }} /> Cambiar foto de perfil
                                                    ...
                                                    <Box sx={{ display: field.value && fileName ? "flex" : "none", marginTop: "10px", justifyContent: "space-between" }}>
